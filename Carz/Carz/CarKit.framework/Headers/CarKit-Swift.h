...
SWIFT_CLASS("_TtC6CarKit3Car")
@interface Car : NSManagedObject
@property (nonatomic, strong) NSNumber * __nonnull year;
@property (nonatomic, copy) NSString * __nonnull make;
@property (nonatomic, copy) NSString * __nonnull model;
